...
(function (domGlobals) {
    ...
    var getLastChildren = function (elm) {
      ...
      var rawNode = elm.dom();
      while (rawNode) {
        children$$1.push(Element.fromDom(rawNode));
    ...
    var trimBr = function (first, block) {
      ...
      }).map(Element.fromDom).filter(isBr).each(remove$2);
    };
    ...
    var mergeTextNodes = function (prevNode, nextNode, normalizeWhitespace) {
      ...
      remove$2(Element.fromDom(nextNode));
    ...
    var replaceWithCaretFormat = function (targetNode, formatNodes) {
      ...
      remove$2(Element.fromDom(targetNode));
    ...
    var SelectionOverrides = function (editor) {
      ...
      var setContentEditableSelection = function (range$$1, forward) {
        ...
        $realSelectionContainer = descendant$1(Element.fromDom(editor.getBody()), '#' + realSelectionId).fold(function () {
          return $([]);
        }, function (elm) {
          return $([elm.dom()]);
        });
      ...
      var removeContentEditableSelection = function () {
        if (selectedContentEditableNode) {
          ...
          descendant$1(Element.fromDom(editor.getBody()), '#' + realSelectionId).each(remove$2);
          selectedContentEditableNode = null;
        }
        descendant$1(Element.fromDom(editor.getBody()), '#' + realSelectionId).each(remove$2);
        selectedContentEditableNode = null;
    ...
    var findBlockCaretContainer = function (editor) {
      return descendant$1(Element.fromDom(editor.getBody()), '*[data-mce-caret]').fold(constant(null), function (elm) {
        return elm.dom();
      });
    };
