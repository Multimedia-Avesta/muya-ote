...
var modern = (function (domGlobals) {
    ...
    var select = function (selector, root) {
      return map(descendants$1(Element.fromDom(root), selector), function (element) {
        return element.dom();
      });
    };
    ...
    var setupUiContainer = function (editor) {
      if (editor.settings.ui_container) {
        global$8.container = descendant$1(Element.fromDom(domGlobals.document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
          return elm.dom();
        });
      }
    };
